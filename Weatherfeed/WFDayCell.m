...
- (void)setDay:(WFDay *)day
{
    ...
    self.maxTempLabel.text = [NSString stringWithFormat:@"%.1fº", [day.tempMax floatValue]];
    self.minTempLabel.text = [NSString stringWithFormat:@"%.1fº", [day.tempMin floatValue]];
